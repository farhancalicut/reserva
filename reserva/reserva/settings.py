...
SECRET_KEY = 'django-insecure-2x_+vq6p%9p-2_0%3cets-p@_c8#*ds-bmdk=@wq88as7m3l5q'
...
INSTALLED_APPS = [
    ...
    'assignmanager.apps.AssignmanagerConfig',
    ...
    'price_details.apps.PriceDetailsConfig',
